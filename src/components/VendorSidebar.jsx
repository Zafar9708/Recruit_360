...
//     { label: 'Jobs', icon: ClipboardList, path: '/vendor/job-postings' },
//     // { label: 'Find Clients', icon: Briefcase, path: '/vendor/jobs' },
//     { label: 'Bench', icon: BookmarkCheck, path: '/vendor/benchlist' },
//     // { label: 'Independent Candidates', icon: Users, path: '/vendor/candidates' },
//     { label: 'Consultant', icon: Users, path: '/vendor/consultant' },
